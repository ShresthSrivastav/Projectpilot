        ...
        service.store_pattern(
            {
                ...
                "description": "",
                "strategy": "Mandatory peer reviews",
                "outcome": "success",
                "confidence": 0.9,
                "tags": [],
                "source_run_ids": ["r1"],
